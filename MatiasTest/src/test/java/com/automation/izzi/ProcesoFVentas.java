...
public class ProcesoFVentas {
	...
	//--------------------------------------------------------------------------------------------------------------------------
		...
		//--------------------------------------------------------------------------------------------------------------------------
		//Este metodo es el paso final de la gestion de compra, donde se muestra el resumente y pasa a la siguiente pesta�a de finalizar compra
	...
	public static void seleccionDeDispositivo(WebDriver driver) throws InterruptedException {
		...
		public static void validacionImei(WebDriver driver) throws InterruptedException {
			...
			Thread.sleep(tiempo);
			//driver.findElement(By.xpath("//input[@id=\'NumberIMEI\']")).sendKeys("355576090532169"); // V�lido
