...
public class ProcesoPortabilidad {
	...
	public void testScript() throws InterruptedException {
		...
		// La siguiente linea realiza la portabildiad del nro por lo que no se va a
		// poder volver a realizar la portabilidad
	...
	public static void portabilidad(WebDriver driver) throws InterruptedException {
		...
		WebElement boton = driver
				.findElement(By.xpath("/html/body/div[1]/div[1]/ng-include/div/div/section/div[3]/button"));
	...
	public static void codigoNIP(WebDriver driver) throws InterruptedException {
		...
		// Descomentar cualquiera de las dos siguientes lineas, de acuerdo a la
		// respuesta que desea colocar

		// Esta opcion afirma que el cliente cuenta con un nro NIP
		new WebDriverWait(driver, 40).until(ExpectedConditions.elementToBeClickable(By.id("RadioNIP")));
		...
		// driver.findElement(By.xpath("//input[@id='RadioNIP' and
		// @value='No']")).click();
